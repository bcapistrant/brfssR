...
#'   \item{age_10ycat_fct}{factor, categorical 10-year age categories (18-24, 25-34,35-44,45-54,55-64,65+)}
...
#'   \item{mstat_cat_fct}{factor, categorical	Married, Divorced, Widowed, Separated, Never Married, Coupled}
#'   \item{married_d_fct}{factor, dichotomous: Married or Coupled Yes/No (No: divorced, widowed, separated, never married)}
#'   \item{chld_num}{numeric, quantiative	0-87}
#'   \item{chld_cat_fct}{factor, categorical	None, One, Two or More}
#'   \item{kids_d_fct}{factor, dichotomous Any Kids Yes/No}
...
#'   \item{reth_imp_cat_fct}{factor, categorical from imputed race (no missing): White Non-Hispanic; Black, Non-Hispanic;  Other, Non-Hispanic; Asian, Non-Hispanic; Native, Non-Hispanic, Hispanic}
...
#'   \item{cvd_d_num}{Cardiovascular Disease: numeric, dichotomous	0/1 (No/Yes)}
#'   \item{strk_d_num}{Stroke: numeric, dichotomous	0/1 (No/Yes)}
#'   \item{diab_d_num}{Diabetes: numeric, dichotomous	0/1 (No/Yes)}
#'   \item{asth_d_num}{Asthma: numeric, dichotomous	0/1 (No/Yes)}
#'   \item{arth_d_num}{Arthritis: numeric, dichotomous	0/1 (No/Yes)}
#'   \item{copd_d_num}{COPD: numeric, dichotomous	0/1 (No/Yes)}
#'   \item{cncr_d_num}{Cancer: numeric, dichotomous	0/1 (No/Yes)}
#'   \item{kidn_d_num}{Kidney Disease: numeric, dichotomous	0/1 (No/Yes)}
...
#'   \item{employed_d_fct}{factor, dichotomous: Employed for Wages or Self-Employed? Yes / No}
...
#'   \item{income_4cats_fct}{factor, categorical: <$20,000; 20,000-34,999; 35,000-74,999; $75,000+}
